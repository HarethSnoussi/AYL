       ...
       <KeyboardAvoidingView  keyboardVerticalOffset={10} behavior={Platform.OS === "ios" ? "padding" : null}>
         <StatusBar hidden />
          ...
          <View style={styles.backgroundContainer}>
            <Image source={{uri:'http://173.212.234.137/assets/tahfifa/woman5.jpg'}} style={{resizeMode:'cover',width:'100%',height:'100%'}}/>
          </View>
          <View style={styles.secondContainer}>
             <View style={styles.logoContainer}>
                 <Image source={{uri:'http://173.212.234.137/assets/tahfifa/logo.png'}} style={styles.logo}/>
