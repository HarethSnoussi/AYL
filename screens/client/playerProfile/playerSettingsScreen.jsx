          ...
          <KeyboardAvoidingView keyboardVerticalOffset={10} behavior={Platform.OS === "ios" ? "padding" : null}>
            <View style={styles.langContainer}>
              {client && client[0].lang?(<View style={styles.langRow}>
                ...
                <Image source={{uri:'http://173.212.234.137/assets/tahfifa/france.png'}} style={{width:24,height:24}}/>
                ...
                <Image source={{uri:'http://173.212.234.137/assets/tahfifa/algeria.png'}} style={{width:24,height:24}}/>
              </View>)}
            </View>
            <View style={styles.buttonContainer}>
